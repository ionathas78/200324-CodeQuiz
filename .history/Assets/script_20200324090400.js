...
function renderQuestion (targetIndex) {
    ...
    var answerIndex = 0;
    var newAnswer = questionObject[questionList._CHOICE_PREFIX + answerIndex];
    ...
    while (newAnswer !== undefined) {
        ...
        answerIndex++;
        newAnswer = questionObject[questionList._CHOICE_PREFIX + answerIndex];
    }
}
...
function addListAnswer (answerText) {
    ...
    var idAnswer = questionList._CHOICE_PREFIX + newIndex;

...
function renderQuestion (_questionIndex) {
    var questionObject = _questionArray[_questionIndex];
    ...
    var answerIndex = 0;
    var newAnswer = questionObject["opt" + answerIndex];
    ...
    while (newAnswer !== undefined) {
        ...
        answerIndex++;
        newAnswer = questionObject["opt" + answerIndex];
    }
}
...
function resolveAnswer(pickIndex) {
    var correctIndex = _questionArray[_questionIndex];

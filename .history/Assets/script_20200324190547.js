...
var _clickListener, _keydownListener, _formListener;
var _intervalTimer;
...
function openForm() {
    ...
    _formListener = document.getElementById("closeButton").addEventListener("click", function () {
        closeForm();
        event.target.removeEventListener("click", _formListener);
    })
        raiseFormOpacity();
  }

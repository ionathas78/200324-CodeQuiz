...
function isInTopTen () {
    ...
    let topTen = localStorage.getItem("topTenList");
    if (topTen === null) {
        topTen = "";
    }
    ...
    console.log(_topTenList);
    
}

function checkTopTen (userInitials) {
    let returnObject = null;

    let topTen = localStorage.getItem("codeQuiz_TopTen");
    if (topTen === null) {
        topTen = "";
    }

    topTenArray = JSON.parse(topTen);
